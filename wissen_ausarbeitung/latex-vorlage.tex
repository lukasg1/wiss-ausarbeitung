...
\input{includes/02_theorie.tex}
\input{includes/03_projektbeschreibung.tex}
\input{includes/04_konzeption.tex}
\input{includes/05_umsetzung.tex}
\input{includes/06_erprobung.tex}
\input{includes/07_diskussion.tex}
\input{includes/08_loesungsarchitektur.tex}
\input{includes/09_evaluation.tex}
